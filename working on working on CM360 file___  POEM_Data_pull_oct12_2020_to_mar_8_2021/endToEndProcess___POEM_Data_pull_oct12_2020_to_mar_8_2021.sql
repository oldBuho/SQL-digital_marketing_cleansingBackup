...
uploading file, careful: impressions has 
text value data eg "1,405" meaning 1405 so managed as varchar data type.
...
COPY public.poem_data_pull_dis_and_vid
FROM 'C:\Users\Public\POEM_Data_pull_oct12_2020_to_mar_8_2021.csv'
DELIMITER ','
CSV HEADER;
